...
function getHeadlines() {
    axios
    .get('https://newsapi.org/v2/top-headlines?country=us&apiKey=245b93f17234480c8618b219b2cee9e9', {
      timeout: 5000
    })
...
function getEverything() {
  axios
  .get('https://newsapi.org/v2/everything?q=bitcoin&apiKey=245b93f17234480c8618b219b2cee9e9', {
    timeout: 5000
  })
  .then(res => showOutput(res))
  .catch(err => console.error(err));
